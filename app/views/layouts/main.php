...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="public/assets/images/favicon/icon.jpg">
    <link rel="icon" type="image/png" sizes="32x32" href="public/assets/images/favicon/icon.jpg">
    <link rel="icon" type="image/png" sizes="96x96" href="public/assets/images/favicon/icon.jpg">
    <link rel="icon" type="image/png" sizes="16x16" href="public/assets/images/favicon/icon.jpg">
