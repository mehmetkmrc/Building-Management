                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown4">
                                ...
                                <a class="dropdown-item" href="two-column.html">İki Sütun</a>
                                <a class="dropdown-item" href="three-column.html">Üç Sütun</a>
                                <a class="dropdown-item" href="three-colum-sidbar.html">Üç Sütun Yan Menü</a>
                                <a class="dropdown-item" href="four-column.html">Dört Sütun</a>
                                <a class="dropdown-item" href="six-colum-full-wide.html">Altı Sütun (Tam Genişlik)</a>
                            </div>
                        </li>
                        <li class="nav-item">
